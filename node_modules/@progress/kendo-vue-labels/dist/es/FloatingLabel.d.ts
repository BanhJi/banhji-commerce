 ...
 * @hidden
 */
export interface FloatingLabelAll extends FloatingLabelMethods, FloatingLabelState, FloatingLabelData, FloatingLabelComputed, Vue {
}
/**
 * Represents the default `FloatingLabel` component.
 */
declare const FloatingLabel: ComponentOptions<Vue, DefaultData<FloatingLabelData>, DefaultMethods<FloatingLabelAll>, FloatingLabelComputed, RecordPropsDefinition<FloatingLabelProps>>;
declare let FloatingLabelVue3: DefineComponent<FloatingLabelProps, any, FloatingLabelData, FloatingLabelComputed, FloatingLabelMethods, {}, {}, {}, string, FloatingLabelProps, FloatingLabelProps, {}>;
export { FloatingLabel, FloatingLabelVue3 };
