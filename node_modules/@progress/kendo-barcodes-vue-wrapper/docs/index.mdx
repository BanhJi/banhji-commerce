...
<Row>
    <Column count={6}>
        <Component href="{% slug overview_barcode %}">
    ...
    <Column count={6}>
        <Component href="{% slug overview_qrcode %}">
...
* [Get Started with the Barcode]({% slug overview_barcode %})
* [Get Started with the QRCode]({% slug overview_qrcode %})
