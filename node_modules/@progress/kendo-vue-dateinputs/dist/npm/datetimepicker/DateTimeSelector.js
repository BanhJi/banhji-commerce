...
exports.DateTimeSelectorVue3 = exports.DateTimeSelector = void 0; // @ts-ignore
...
var utils_2 = require("../timepicker/utils"); // tslint:enable:max-line-length
...
var DateTimeSelector = {
  ...
  props: {
    ...
    min: {
      type: Date,
      default: utils_1.MIN_DATE
    },
    max: {
      type: Date,
      default: utils_1.MAX_DATE
    },
    maxTime: {
      type: Date,
      default: function _default() {
        return kendo_vue_common_1.cloneDate(utils_1.MAX_TIME);
      }
    },
    minTime: {
      type: Date,
      default: function _default() {
        return kendo_vue_common_1.cloneDate(utils_1.MIN_TIME);
      }
    },
    weekNumber: {
      type: Boolean,
  ...
  created: function created() {
    ...
    this.timeValue = this.$props.value || defaults_1.MIDNIGHT_DATE;
  },
  inject: {
  ...
  render: function render(createElement) {
    ...
    var calendar = kendo_vue_common_1.getTemplate.call(this, {
      h: h,
  ...
  methods: {
    ...
    normalizeRange: function normalizeRange(candidate, value) {
      return kendo_date_math_1.isEqualDate(candidate, value || utils_1.getToday()) ? candidate : null;
    },
    ...
    handleReject: function handleReject(event) {
      this.dateValue = this.$props.value;
      this.timeValue = this.$props.value || defaults_1.MIDNIGHT_DATE;
      var value = this.mergeDate(this.$props.value, this.$props.value || defaults_1.MIDNIGHT_DATE);
      var args = {
        event: event,
        target: this,
        value: value
    ...
    handleNowClick: function handleNowClick(event) {
      this.timeValue = utils_2.getNow();
      this.handleAccept(event, utils_2.getNow());
    },
...
exports.DateTimeSelectorVue3 = DateTimeSelectorVue3;