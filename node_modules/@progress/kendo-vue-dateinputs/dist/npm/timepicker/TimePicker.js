...
exports.TimePickerVue3 = exports.TimePicker = void 0; // @ts-ignore
...
var TimePicker = {
  ...
  render: function render(createElement) {
    ...
    var toggleTimeMessage = localizationService.toLanguageString(messages_1.toggleTimeSelector, messages_1.messages[messages_1.toggleTimeSelector]);
  ...
  methods: {
    ...
    mergeTime: function mergeTime(value) {
      return this.computedValue && value ? utils_1.setTime(this.computedValue, value) : value;
    },
    ...
    handleValueChange: function handleValueChange(event) {
      this.currentValue = kendo_date_math_1.cloneDate(event.value);
...
exports.TimePickerVue3 = TimePickerVue3;