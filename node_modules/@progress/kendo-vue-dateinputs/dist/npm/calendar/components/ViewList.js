...
exports.ViewListVue3 = exports.ViewList = void 0; // @ts-ignore
...
var ViewList = {
  ...
  computed: {
    weekNames: {
      get: function get() {
        ...
        var weekNames = utils_1.shiftWeekNames(this._intl.dateFormatNames({
          nameType: 'short',
          type: 'days'
        }), this._intl.firstDay());
  ...
  methods: {
    ...
    calculateHeights: function calculateHeights() {
      ...
      var scrollableHeight = this.$props.activeView === models_1.CalendarViewEnum.month ? this.$props.dom.scrollableContentHeight : this.$props.dom.scrollableYearContentHeight;
  ...
  render: function render(createElement) {
    ...
    var tableClassNames = kendo_vue_common_1.classNames('k-calendar-table', 'k-content', 'k-calendar-content', {
      'k-month': this.$props.activeView === models_1.CalendarViewEnum.month,
      'k-year': this.$props.activeView === models_1.CalendarViewEnum.year,
      'k-decade': this.$props.activeView === models_1.CalendarViewEnum.decade,
      'k-century': this.$props.activeView === models_1.CalendarViewEnum.century
    });
    ...
    var buildDates = function buildDates() {
      ...
      return this.$props.dates.map(function (vDate) {
        ...
        }, [this.$props.activeView === models_1.CalendarViewEnum.month && buildMonthView.call(this, this.weekNames), // @ts-ignore function children
        h(View_1.View, {
          key: vDate.getTime(),
...
exports.ViewListVue3 = ViewListVue3;