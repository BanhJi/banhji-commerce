...
var DateInput = {
  ...
  props: {
    ...
    max: {
      type: Date,
      default: function _default() {
        return kendo_date_math_1.cloneDate(utils_2.MAX_DATE);
      }
    },
    min: {
      type: Date,
      default: function _default() {
        return kendo_date_math_1.cloneDate(utils_2.MIN_DATE);
      }
    },
    maxTime: {
      type: Date,
      default: function _default() {
        return kendo_date_math_1.cloneDate(defaults_1.MAX_TIME);
      }
    },
    minTime: {
      type: Date,
  ...
  created: function created() {
    ...
    this.kendoDate = new models_1.KendoDate(this.intl, formatPlaceholder, format);
  ...
  methods: {
    ...
    elementChange: function elementChange(event) {
      ...
      var diff = utils_1.approximateStringMatching(text, this.$data.currentFormat, element.value, this.selection().start);
    ...
    validity: function validity() {
      var inRange = utils_1.isInRange(this.computedValue, this.$props.min, this.$props.max) && utils_3.isInTimeRange(this.computedValue, this.$props.minTime, this.$props.maxTime);
