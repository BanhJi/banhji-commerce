...
The below code used to display the components' icons but after and update, Katana is throwing errors when it is applied

<Row>
    <Column count={6}>
        <Component href="{% slug overview_chart_charts %}">
...
* [Get Started with the Chart]({% slug overview_chart_charts %})
* [Get Started with the Sparkline]({% slug overview_sparkline_charts %})
* [Get Started with the StockChart]({% slug overview_stockchart_charts %})
