...
var FloatingActionButton = {
  ...
  computed: {
    buttonClassNames: function buttonClassNames() {
      return kendo_vue_common_1.classNames('k-fab', "k-fab-" + this.$props.themeColor, "k-fab-" + this.$props.shape, {
  ...
  methods: {
    ...
    handleItemDown: function handleItemDown(event) {
      if (kendo_vue_common_1.canUseDOM && document.activeElement === this.element) {
        event.preventDefault();
      }
    },
  ...
  render: function render(createElement) {
    ...
    var fabItems = function fabItems() {
      return items && items.map(function (element, index) {
        return (// @ts-ignore  function children
          h(FloatingActionButtonItem_1.FloatingActionButtonItem, {
            key: index,
            index: index,
    ...
    return h("div", {
      ...
      "class": kendo_vue_common_1.classNames("k-fab-icon k-icon k-i-" + icon)
    }) : iconClass ? h("span", {
      role: "presentation",
      attrs: this.v3 ? undefined : {
        role: "presentation"
