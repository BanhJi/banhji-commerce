  ...
  render: function render(createElement) {
    ...
    var operators = (field && field.operators || []).map(function (o) {
      return __assign(__assign({}, o), {
        text: locService.toLanguageString(o.text, messages_1.messages[o.text] || o.text)
      });
    });
    ...
    h(kendo_vue_buttons_1.Toolbar, {
      ...
      return [field && filterEditors.call(_this, field.filter, field.filterRender)];
    } : [field && filterEditors.call(_this, field.filter, field.filterRender)]), h(kendo_vue_buttons_1.ToolbarItem, _this.v3 ? function () {
