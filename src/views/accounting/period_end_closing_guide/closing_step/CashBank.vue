        ...
        <v-col cols="12" sm="12" class="pt-0">
            <v-row>
                <v-col sm="8" class="py-0">
                    <h2 class="mb-3 float-left primary--text text-uppercase">
                        {{ $t("cash_bank") }}
                    </h2>
                ...
                <v-col sm="4" class="py-0">
                    <!-- <v-btn color="primary" class=" white--text float-right text-capitalize" link to="period_end_closing_guide">
                        ...
                        >
                            <template v-slot:default>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <v-btn class="bg-none">
                                            <v-icon class="primary--text" size="17">
                                                fas fa-eye
                                            </v-icon>
                                        </v-btn>
                                    </td>
