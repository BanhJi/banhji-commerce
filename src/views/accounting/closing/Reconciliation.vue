                    ...
                    <v-card outlined dense class="pa-4 no_border rounded-sm" color="white">
                        <v-form ref="form" v-model="valid" lazy-validation>
                            <v-card outlined dense class="no_border">
                                <h2 class="mb-0">{{$t('reconciliation')}}</h2>
                                <v-icon
                            ...
                            <v-card outlined dense class="px-3 no_border mb-3" color="white">
                                <v-row  style="background: #F8F8F9;">
                                    <v-col sm="4" cols="12" class="pb-0">
                                        ...
                                        <app-datepicker :initialDate="reconcile.date" @emitDate="reconcile.date = $event"/>
                                    </v-col>
                                    <v-col sm="4" cols="12" class="pb-0 ">
                                    ...
                                    <v-col sm="4" cols="12" class="pb-0">
                                        ...
                                        <v-select class="mt-1" outlined placeholder="Percentange"/>
                                    </v-col>
                                </v-row>
                                <v-row>
                                    ...
                                    <v-col  sm="2" cols="12" class="pb-0">
                                        <v-btn color="primary"
                                                class="dropdown_transactions mt-6 white--text float-left text-capitalize"
												@click="search">
                                            {{$t('view')}}
                                        </v-btn>
                                    </v-col>
                                        ...
                                        <v-col sm="6" cols="12">
                                            <v-simple-table >
                                                <template v-slot:default>
                                                    <tbody>
                                                    <tr>
                                                        <td class="text-uppercase">{{$t('gl_balance')}}</td>
                                                        <td class="primary--text text-right">{{ Number(reconcile.ending_balance).toLocaleString() }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-uppercase">{{$t('txn_balance')}}</td>
                                                        <td class="text-right text-bold">0</td>
                                                    </tr>
                                                    <tr class="primary">
                                                        <td class="text-uppercase">{{$t('variance')}}</td>
                                                        <td class="primary--text text-right text-bold">0</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-uppercase">{{$t('adjustment_account')}}</td>
                                                        <td class="primary--text text-right text-uppercase text-bold">
															<v-select class="mt-1"
																placeholder="Select Adjustment Account"
																v-model="reconcile.adjustment_account"
																:items="accounts"
																item-text="name"
																item-value="uuid"
																return-object
...
<script>
    ...
    const {AccountTypeCode, EntityType, SaveOption} = require("@/scripts/default_setup/Collections");
			...
			.then(res => {
				if(res){
                    ...
                    res.data.forEach(value => {
                        ...
                        if(~AccountTypeCode.RECONCILE_OTHER_ACCOUNTS.indexOf(value.account_type.code)){
