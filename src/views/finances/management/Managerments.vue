...
export default {
  ...
  components: {
    LoanCenter: () => import("./loan_center/LoanCenter"),
    LoanBalances: () => import("./LoanBalances"),
    RepaymentReport: () => import("./RepaymentReport"),
    // RepaymentSchedules: () => import("./RepaymentSchedules"),
    // LoansMonitoring: () => import("./LoansMonitoring"),
    TypeOfLoans: () => import("../settings/TypeOfLoans"),
  },
};
</script>
<style scoped>
