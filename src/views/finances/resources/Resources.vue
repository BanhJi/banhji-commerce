...
export default {
  ...
  components: {
    FanancingOptions: () => import("./FanancingOptions"),
    LoanCalculator: () => import("./loan_calculator/LoanCalculator"),
    ApprovalFactors: () => import("./ApprovalFactors"),
    // CreditGuarantee: () => import("./CreditGuarantee"),
  },
  mounted() {},
};
</script>
