        ...
        <v-simple-table class="my_tb">
          <template v-slot:default>
            <tbody>
              ...
              <tr v-for="(i, index) in z_score" :key="index">
                <td>{{ i.text }}</td>
                <td></td>
                <td></td>
                <td></td>
...
export default {
  data: () => ({
    ...
    z_score: [
        {
            text: 'EBIT/ Total Assets'
        },
        {
            text: 'Total Revenue / Total Assets'
        },
        {
            text: 'Total Equities / Total Liabilities'
        },
        {
            text: 'Working Capital / Total Assets'
        },
        {
            text: 'Retained Earning / Total Assets'
        },
        {
            text: 'Total Z Score'
        },
