        ...
        <v-tab-item>
          <v-card flat>
            <v-card-text class="py-0 pr-0">
              <StatementFinancialPositionTabs />
            </v-card-text>
          </v-card>
        </v-tab-item>
        <v-tab-item>
...
export default {
  ...
  components: {
    StatementFinancialPositionTabs: () =>
      import("./statement_finance_position/StatementFinancialPositionTabs"),
    StatementFundBalances: () =>
      import("/src/views/accounting/reports/fund_balance/Tab"),
  },
};
</script>
<style scoped>
