                        ...
                        <v-row>
                            <v-col class="bigSide py-0" sm="8" cols="12" style="transition: .3s ease-in;"
                                ...
                                <v-form ref="form" v-model="valid" lazy-validation>
                                    <v-card outlined dense class="no_border">
                                        <h2 class="mb-0">{{$t('recurring_purchase')}}</h2>
                                    ...
                                    <v-card outlined dense class="px-3 no_border" color="grayBg" height="335px">
                                        <v-row >
                                            ...
                                            <v-col sm="8" cols="12" class="mt-6" >
                                                <v-row style="background-color: #d5dce4;"  class="mr-0">
                                                    <v-col class="pb-0" sm="12" cols="12" >
                                                        <h3 class="mb-0 text-white">{{$t('recurring_information')}}</h3>
                                                    </v-col>
                                                    ...
                                                    <v-col class="pb-0" sm="6" cols="12" >
                                                        ...
                                                        <label class="label">{{$t('end_date_optional')}}</label>
                                                        <app-datepicker :initialDate="journal_date"
                                                                        @emitDate="journal_date = $event"/>
                                                    </v-col>
                                                </v-row>
                                        ...
                                        <v-col sm="12" cols="12" class="py-0">
                                            <v-row>
                                                <v-col class="pt-0" sm="6" cols="6">
                                                    <v-card class="no-boxshadow pa-3" color="grayBg" height="252px">
                            ...
                            <v-col class="smallSide" sm="4" style="transition: .3s ease-in;"
                                ...
                                <div v-if="!isHideBar" class="small_sidebar mt-9 px-4 grayBg">
                                    ...
                                    <p class="mb-0 detial_smallside_p">{{$t('recurring_purchase_funct_desc')}}</p>
                                </div>
                            </v-col>
                        </v-row>
