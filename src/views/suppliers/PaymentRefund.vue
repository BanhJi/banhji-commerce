                        ...
                        <v-row>
                            <v-col class="bigSide py-0" sm="8" cols="12" style="transition: .3s ease-in;"
                                ...
                                <v-form ref="form" v-model="valid" lazy-validation>
                                    <v-card outlined dense class="no_border">
                                        <h2 class="mb-0">{{$t('payment_refund')}}</h2>
                                    ...
                                    <v-card outlined dense class="px-3 no_border" color="grayBg" height="170px">
                                        <v-row >
                                            ...
                                            <v-col sm="4" cosl="12">
                                                ...
                                                <v-row class="mt-1 mr-0">
                                                    <v-col sm="3" cols="3" class="py-0 pr-0">
                                                        <div class="code_text text-uppercase">inv</div>
                                                    </v-col>
                                                    <v-col sm="7" cols="8" class="py-0 pl-0 pr-1">
                                    ...
                                    <v-row style="background-color: #fff;">
                                        <v-col sm="12" cols="12" class="pb-0">
                                            <p class="mb-3">{{$t('item_deposit_refunded')}}</p>
                                        </v-col>
                                        ...
                                        <v-col sm="12" cols="12" class="pb-0">
                                            <v-row >
                                                <v-col sm="9" cols="12" class="pb-0">
                                                    <v-btn color="primary" class="float-left rounded-0 white--text mr-2" @click="addRow">
                                                        <v-icon size="" class="ma-1">mdi-plus</v-icon>
                                                    </v-btn>
                                                    <v-btn color="primary" class="float-left rounded-0 white--text mr-2">
                                                        <v-icon size="" class="ma-1">fa fa-barcode</v-icon>
                                                    </v-btn>
                                                    <v-btn color="third" class="float-left rounded-0 text-capitalize white--text mr-2" to="add_item">
                                                        {{$t('add_item')}}
                                                    </v-btn>
                                                    <v-btn color="secondary" class="float-left rounded-0 text-capitalize mr-2 white--text">
                                                        {{$t('sub_total')}}
                                                    </v-btn>
                                                    <template>
                                                        <v-file-input class="mt-0 py-0 " sm="3" cols="6"
                                                                      v-model="files"
                                    ...
                                    <v-row style="background-color: #fff;">
                                        <v-col cosl="12" class="mb-0 pt-0">
                                            <p class="mb-0">{{$t('cash_account_used_refund')}}</p>
                                        </v-col>
                                        <v-col sm="12" cols="12" class="py-0">
                                            <kendo-datasource ref="dataSource"
                                                              :data="suppliers_item"
                                        ...
                                        <v-col sm="12" cols="12" class="py-0">
                                            <v-row>
                                                <v-col sm="6" cols="6">
                                                    <v-card class="no-boxshadow pa-3" color="grayBg" height="250px">
                            ...
                            <v-col class="smallSide" sm="4" style="transition: .3s ease-in;"
                                ...
                                <h3 style="color: #b3b5bc; font-size:20px;" v-if="!isHideBar" class="text-uppercase float-right mt-n3">
                                    <span class="pointer" @click="Help('payment refund')">
                                        {{ $t('help') }}
                                    </span>
                                    <v-icon
                                            onclick="window.history.go(-1); return false;"
                                ...
                                <div v-if="!isHideBar" class="small_sidebar mt-9 px-4 grayBg">
                                    ...
                                    <p class="mb-0 detial_smallside_p">{{$t('cash_refund_funt_desc')}}</p>
                                </div>
                            </v-col>
                        </v-row>
