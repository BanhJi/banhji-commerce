                        ...
                        <v-card outlined dense color="white" class="no_border mb-4" >
                            <v-row>
                                <v-col sm="9" cols="12" class="py-0">
                                    <h2 class="mb-1 font_20">{{$t('vendors_balance_payments')}}</h2>
                                </v-col>
                            </v-row>
                            <v-row>
                                <v-col sm="12" cols="12" class="pt-0">
                                    <chart ref="chart"
                                           ...
                                           :chartArea='{ background: "transparent",height: 280,  }'
                                           :tooltip="tooltip"
                                           :series="series_line"
