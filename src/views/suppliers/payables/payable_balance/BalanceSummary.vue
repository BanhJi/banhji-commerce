            ...
            <v-card color="white" class="pa-3 no_border" elevation="0">
                <v-row>
                    <v-col sm="12" cols="12" class="pt-0">
                        <h2 class="mb-1 font_20">{{ $t("balance_summary") }}</h2>
                        <p class="mb-0">{{ $t("payable_summary_desc") }}</p>
                    </v-col>
...
<!--                            <h3 class="text-right mt-6  font_20 flex-1">{{ overDueAmount }}</h3>-->
<!--                        </v-card>-->
<!--                    </v-col>-->
                    <v-col sm="4" cols="12" class="pt-0">
                        <v-card outlined dense class="pa-3 no_border white--text"
                                color="third" height="60px">
                    ...
                    <v-col sm="4" cols="12" class="pt-0">
                        <v-card outlined dense class="pa-3 no_border black--text"
                                color="grayBg" height="60px">
                            <h3 class="text-left font_13 flex-1 text-uppercase">{{ $t('supplier') }}</h3>
