                                        ...
                                        <v-row>
                                            ...
                                            <v-col sm="6" cols="12" class="pb-0">
                                                ...
                                                <v-row class="mt-1 pb-0">
                                                    ...
                                                    <v-col sm="8" cols="8" class="pt-0 pl-0 pr-1 pb-0">
                                                        <v-text-field
                                        ...
                                        <v-tab-item eager>
                                            <v-row>
                                                <v-col class="py-0" cols="12">
                                                    <p class="color_grey">{{ $t("inv_vendor_func_tax") }}</p>
                                                </v-col>
                                                <v-col class="py-0" sm="6" cols="12">
                                                    <label class="label mb-0">{{ $t("account_payable") }}</label>
                                                    <v-select
                                                        class="mt-1"
                                                        v-model="mAccPayable"
                                                        :items="accPayable"
                                                        ...
                                                        :rules="[(v) => !!v || $t('is_required')]"
                                                        outlined/>
                                                    <label class="label mb-0">{{ $t("purchase_deposit") }}</label>
                                                    <v-select
                                                        class="mt-1"
                                                        v-model="mAccDeposit"
                                                        :items="accDeposit"
...
export default {
    ...
    methods: {
        ...
        onSaveCloseAddress() {
            if (this.addresses) {
                window.console.log(1111112, this.newClick)
                if (this.newClick) {
                    ...
                    if (index < 0) {
                        window.console.log(1, addr)
                        this.addresses.push(addr);
                    } else {
                        window.console.log(2, addr)
                    ...
                    if (this.$route.params.id) {
                        ...
                        supplierHandler.get(this.$route.params.id).then((res) => {
                            if (res.data.statusCode === 200) {
                                ...
                                this.addressList = this.supplier.contactAddress.address || []
            ...
            new Promise((resolve) => {
                setTimeout(() => {
                    ...
                    bankAccountHandler.getAll().then((res) => {
                        ...
                        if (res.data.statusCode === 200) {
                            this.bankInstitution = res.data.data;
