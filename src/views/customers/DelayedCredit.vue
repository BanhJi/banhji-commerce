                                ...
                                <v-form ref="form" v-model="valid" lazy-validation>
                                    ...
                                    <v-card outlined dense class="px-3 no_border" color="grayBg">
                                        <v-row >
                                            ...
                                            <v-col sm="4" cols="12" class="pb-0">
                                                ...
                                                <v-row class="mt-1 mr-0">
                                                    <v-col sm="3" cols="3" class="pt-0 pr-0">
                                                        <div class="code_text text-bold">INV</div>
                                                    </v-col>
                                            ...
                                            <v-col sm="4" cols="12" class="pb-0">
                                                <!-- hidden for layout -->
                                                <label style="visibility: hidden;" class="label  mb-0">{{$t('invoice_currency')}}</label>
                                                <v-select style="visibility: hidden;" class="mt-1"
                                        ...
                                        <v-col sm="12" cols="12" class="pb-0">
                                            <v-row >
                                                <v-col sm="9" cols="12" class="">
                                                    ...
                                                    <v-btn class="float-left rounded-0 white--text add_account mr-2" to="add_item">
                                                        {{$t('add_account')}}
                                                    </v-btn>
                            ...
                            <v-col class="smallSide" sm="4" style="transition: .3s ease-in;"
                                ...
                                <div v-if="!isHideBar" class="small_sidebar mt-9 px-4 grayBg">
                                    <v-card class="pa-3 no-boxshadow"  style="min-height: 70px; background-color: #00b050 !important;">
                                        <h3 style="font-size: 18px" class="text-white text-uppercase mb-2">{{$t('amount_credit')}}</h3>
                                        <h3 class="text-bold float-right text-white" style="font-size: 22px">200</h3>
                                    </v-card>
                              
                      
                                    <p class="mb-0 detial_smallside_p font_14">{{$t('delayed_credit_funct_desc')}}</p>
                                </div>
                            </v-col>
                        </v-row>
