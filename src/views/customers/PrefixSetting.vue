<template>
    <v-row class="">
        <v-col sm="12" cols="12">
            <h2>{{$t('account_prefix_setting')}}</h2>
                    ...
                    <v-card-text class="modal_text_content">
                        <v-row>
                            <v-col sm="6" cols="12" class="">
                                ...
                                <v-text-field class=" mb-3" v-bind:value="prefix.abbr"
                                              v-model="prefix.abbr"
                                              outlined
                                ...
                                <v-text-field class=" mb-3" v-bind:value="prefix.number" type="number"
                ...
                <v-simple-table class="exchange-table">
                    <template v-slot:default>
                        ...
                        <tr v-for="prefix in account_prefixes" v-bind:key="prefix.sk">
                            ...
                            <td class="text-bold" width="15%" style="text-align: left">
                                {{prefix.name}}
                            </td>
        ...
        methods: {
            ...
            async loadPrefixes() {
                new Promise(resolve => {
                    setTimeout(() => {
                        resolve('resolved');
                        axios.get(apiUrl.journal_prefix_get)
                            .then(res => {
                                //eslint-disable-next-line no-console
