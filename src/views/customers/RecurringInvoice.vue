                            ...
                            <v-col class="bigSide py-0" sm="8" cols="12" style="transition: .3s ease-in;"
                                ...
                                <v-form ref="form" v-model="valid" lazy-validation>
                                    <v-card outlined dense class="no_border">
                                        <h2 class="mb-0">{{$t('recurring_invoice')}}</h2>
                                            ...
                                            <v-col sm="8" cols="12" class="">
                                                <v-row class="info_add mr-0">
                                                    <v-col cols="12" class="pb-0">
                                                        <h3 class="color_white">{{$t('recurring_information')}}</h3>
                                                    </v-col>
                                                    <v-col sm="6" cols="12">
                                                        <label class="label mb-0">{{$t('recurring_everyday')}}</label>
                                                        <v-row>
                                                            <v-col cols="3" class="pb-0 pr-0 pt-0">
                                                                <v-text-field class="mt-1"
                                                                    outlined
                                                                    tage="Recurring Everyday"
                                                                    placeholder="1"
                                                                    />
                                                            </v-col>
                                                    ...
                                                    <v-col sm="6" cols="12">
                                                        <label class="label mb-0">{{$t('invoice_start_date')}}</label>
                                                        <app-datepicker :initialDate="journal_date"
                                                                        @emitDate="journal_date = $event"/>

                                                        <label class="label mb-0">{{$t('end_date_optional')}}</label>
                                                        <app-datepicker :initialDate="journal_date"
                                                                        @emitDate="journal_date = $event"/>
                                                ...
                                                <p class="mb-2 ml-n3 mt-3 color_grey">{{$t('additional_information')}}</p>

                                                <v-row style="background-color: #fff;"  class="mr-0">
                                                    <v-col class="pb-0" sm="6" cols="12" >
                                                        <label class="label mb-0">{{$t('discount_promotion')}}</label>
                                                        <v-select class="mt-1"
                                                              :items="suppliers"
                                                              tage="Discount Promotion"
                                                              placeholder="Term"
                                                              outlined
                                                        />
                                        ...
                                        <v-col sm="12" cols="12" class="pb-0">
                                            <v-row >
                                                <v-col sm="9" cols="12" class="">
                                                    <v-btn class="float-left btn_plus mr-2 rounded-0" @click="addRow">
                                                        <v-icon size="" class="ma-1">mdi-plus</v-icon>
                                                    </v-btn>
                                                    <v-btn class="float-left btn_plus mr-2 rounded-0" @click="addRow">
                                                        <v-icon size="" class="ma-1">fa fa-barcode</v-icon>
                                                    </v-btn>
                                                    <v-btn class="float-left white--text rounded-0 add_account mr-2" to="add_item">
                                                        {{$t('add_item')}}
                                                    </v-btn>
                                                    <v-btn class="float-left add_account mr-2 btn_save_draft rounded-0">
                                                        {{$t('sub_total')}}
                                                    </v-btn>
                                                    <template>
                                            ...
                                            <v-row>
                                                <v-col sm="6" cols="6" class="pt-0">
                                                    <v-card class="no-boxshadow pa-3" color="grayBg">
                                                        <v-row>
                                                            <v-col class="py-0" sm="6" cols="5">
                                                                <label class="label mb-0">{{$t('billing_address')}}</label>
                                                                <v-select class="mt-1"
                                                                          :items="suppliers"
                                                            ...
                                                            <v-col class="py-0" sm="6" cols="7">
                                                                <label class="label mb-0">{{$t('pickup_delivery_address')}}</label>
                                                                <v-select class="mt-1"
                                                                          :items="suppliers"
                                    ...
                                    <v-card outlined dense class="no_border function_footer">
                                        ...
                                        <v-btn color="black" class="float-left white--text text-capitalize" @click="cancel">{{$t('cancel')}}</v-btn>
                                        <v-menu>
                                            <template v-slot:activator="{ on }">
                                            ...
                                            <v-list rounded>
                                                <v-list-item-group>
                                                    ...
                                                    <v-list-item>
                                                        <v-list-item-content>
                                                            <v-list-item-title @click="savePrint">{{$t('save_close')}}
                                                            </v-list-item-title>
                                                        </v-list-item-content>
                                                    </v-list-item>
                                                </v-list-item-group>
                            ...
                            <v-col class="smallSide" sm="4" style="transition: .3s ease-in;"
                                ...
                                <div v-if="!isHideBar" class="small_sidebar mt-9 px-4 grayBg">
                                    <v-card class="pa-3 no-boxshadow"  style="min-height: 70px; background-color: #00b050 !important;">
                                        <h3 style="font-size: 18px" class="text-white text-uppercase mb-2">{{$t('amount_due')}}</h3>
                                    ...
                                    <v-row>
                                        ...
                                        <v-row>
                                            <v-col sm="12" cols="12" class="py-0">
                                                <label class="label mt-2">{{$t('payment_options')}} (<span style="color:#1bb5f1">{{$t('get_setup')}}</span>)</label>
                                            </v-col>
                                            <v-col sm="12" cols="12">
                                                <v-row>
                                    ...
                                    <p class="mb-0 detial_smallside_p font_14">{{$t('sale_recurring_funct_invoice')}}</p>
                                </div>
                            </v-col>
                        </v-row>
