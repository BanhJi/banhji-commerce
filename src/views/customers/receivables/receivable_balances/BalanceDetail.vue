            ...
            <v-card color="white" class="pa-3 no_border" elevation="0">
                <v-row>
                    <v-col sm="12" cols="12" class="py-0">
                        <h2 class="mb-0 font_20">{{ $t('receivable_balance_detail') }}</h2>
                        <p class="mb-3">{{ $t('receivable_management_desc') }}</p>
                    </v-col>
                    ...
                    <!--                :fields="exfield"-->
                    <!--                type="xls"-->
                    <!--                worksheet="AR Balance Detail"-->
                    <!--                name="ReceivableBalance.xls">-->
                ...
                <v-row class="mt-0">
                    <v-col sm="4" cols="12" class="pt-0">
                        <v-card outlined dense class="pa-3 no_border rounded-4 white--text" color="third"
                                height="60px">
                            <h3 class="text-left font_12 text-uppercase flex-1">{{ $t('overdue_amount') }}</h3>
                            <h3 class="text-right mt-0  font_20 flex-1">{{ overDueAmount }}</h3>
                        </v-card>
                    </v-col>
                    <v-col sm="4" cols="12" class="pt-0">
                        <v-card outlined dense class="pa-3 no_border rounded-4 white--text " color="third"
                                height="60px">
                            <h3 class="text-left font_12 flex-1 text-uppercase">{{ $t('receivable_balance') }}</h3>
                            <h3 class="text-right flex-1 font_20 mt-0">{{ receivableBalance }}</h3>
                        </v-card>
                    </v-col>
                    <v-col sm="4" cols="12" class="pt-0">
                        <v-card outlined dense class="pa-3 no_border rounded-4 white--text" color="third"
                                height="60px">
                            <h3 class="text-left font_12 flex-1 text-uppercase">{{ $t('to_be_collected') }}</h3>
                            <h3 class="text-right flex-1 font_20 mt-0">{{ tobeCollected }}</h3>
                        </v-card>
                    </v-col>
                </v-row>
