    ...
    <v-row>
        <v-col sm="12" cols="12" class="pt-0">
            <v-card color="white" class="pl-2 no_border" elevation="0">
                <h2 class="mb-0">{{$t('sale_summary_by_promotions_discounts')}}</h2>
                <p class="mb-0">{{$t('sale_summary_by_promotions_discounts_desc')}}</p>
                        ...
                        <template>
                            <v-simple-table class="attachment_table">
                                <template v-slot:default>
                                    <thead>
                                    <tr>
                                        <th>{{$t('promotions_discounts')}}</th>
                                        <th>{{$t('%')}}</th>
                                        <th>{{$t('value_of_the_discount')}}</th>
                                        <th>{{$t('no_of_customer')}}</th>
                                        <th>{{$t('gross_sale')}}</th>
                                        <th>{{$t('margin_%')}}</th>
