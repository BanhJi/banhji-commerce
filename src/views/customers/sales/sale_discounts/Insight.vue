                ...
                <template>
                  <tbody>
                    <tr>
                      <td class="text-left pl-0">
                        <span
                          class="niradei_medium font_14 grey--text text-capitalize"
                        >
                          {{ $t("new") }}
                        </span>
                      </td>
        ...
        <v-col class="py-md-0 px-md-2" sm="4" cols="12">
          ...
          >
            <v-row>
              ...
              <h4
                class="text-right white--text flex_right col-md-6 col-sm-12 py-0 font_16 text-uppercase"
              >
                {{ $t("over_credit_limit") }}
              </h4>
            </v-row>
                  ...
                  <v-simple-table class="mt-2">
                    <template>
                      <tbody>
                        <tr>
                          <td
                            class="text-right line_16 py-2 text-capitalize pr-0"
                          >
                            <span class="niradei_heavy font_18 dark_grey">
                              {{ mostTermUsed }}
                            </span>
