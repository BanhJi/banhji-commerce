            ...
            <v-card color="white" class="pa-3 no_border" elevation="0">
                <v-row class="">
                    <v-col sm="12" cols="12" class="py-0">
                        <h2 class="mb-0 font_20">{{ $t("other_charge") }}</h2>
                                    ...
                                    <v-form ref="form" v-model="valid" lazy-validation>
                                        <v-row>
                                            ...
                                            <v-col sm="6" cols="12" class="py-0">
                                                ...
                                                <v-textarea rows="4" no-resize height="70px"
                                                            class="mt-1"
                ...
                <v-row class="">
                    <v-col sm="12" cols="12" class="pb-0">
                        ...
                        <template>
                            ...
                            <kendo-grid id="gridOtherChargeItem" class="grid-function"
                                        :data-source-ref="'otherChargeItemDS'"
                                        :editable="false"
                                        :toolbar="toolbarTemplate"
                                        :excel-export="excelExport"
                                        :excel-file-name="'OtherChargeItem.xlsx'"
        ...
        async onSaveClose() {
            ...
            new Promise(resolve => {
                setTimeout(() => {
                    ...
                    otherChargeHandler.create(data).then(response => {
