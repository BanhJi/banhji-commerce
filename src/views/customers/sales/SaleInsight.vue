        ...
        <v-row>
          <v-col class="py-0 pr-md-2" sm="4" cols="12">
            ...
            >
              ...
              <h6 class="pa-0 text-right font_20 col-md-7 col-xs-12">50%</h6>
            </v-card>
            <v-card
              outlined
              dense
            ...
            >
              <h4 class="pa-0 text-uppercase col-md-5 col-xs-12 font_13 flex-1">
                {{ $t("working_capital_to_sale") }}
              </h4>
              <h6 class="pa-0 text-right font_20 col-md-7 col-xs-12 flex-1">
                50%
              </h6>
            </v-card>
          </v-col>
          <v-col class="py-md-0 px-md-2" sm="4" cols="12">
            <v-card
              ...
              color="grayBg"
            >
              <h3 class="font_20">{{ $t("total_revenue") }}</h3>
              <p class="mb-0">
          ...
          <v-col class="py-0 pl-md-2" sm="4" cols="12">
            <v-card
              ...
              color="grayBg"
            >
              <h3 class="font_20">{{ $t("sale_analysis") }}</h3>
              <p class="mb-0">
                {{ $t("from_the_beginning_year") }}
              </p>
              <template>
                <v-simple-table class="mt-11">
                  <template>
                      <tbody>
                      <tr>
                        <td class="text-left">
                      ...
                      <tr>
                        <td class="text-left">
                          <span class="niradei_medium font_14 grey--text">
                            {{ $t("working_capital_to_sale_ratio") }}
                          </span>
                        </td>
                        <td class="text-right">
                          <span class="niradei_heavy font_18 dark_grey">
              ...
              <!-- <h3 class="font_20">{{ $t("sale_plan_vs_actual") }}</h3>
                            <p class="mb-8">
                                {{ $t('from_the_beginning_year') }}
                            </p>
                            <template>
