...
export default {
  ...
  methods: {
    ...
    excelExport(e) {
      const gridRef = $("#gridCDirectory thead").find(
        "[data-role= 'columnmenu']"
      );
      const gridRefHeadNone = $("#gridCDirectory thead").find(
        "[style*='display: none' ]"
      );
      ...
      sheet.mergedCells = [
        "A1:" + charName[gridRef.length - gridRefHeadNone.length] + 1,
      ];
      sheet.name = "Orders";
