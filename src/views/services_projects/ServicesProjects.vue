                        ...
                        <v-row>
                            <v-col sm="12" cols="12" class="tab_wrapper py-0">
                                <v-tabs v-model="active_in_tabs">
                                    <v-row>
                                        <v-col sm="12" cols="10" class="py-0 pr-0" style="display: inherit;">
                                            ...
                                            <v-tab v-if="productType != 'Cooperative'  && productType !== 'Standard' ">
                                                <span>
                                                    {{ $t('projects') }}
                                                </span>
                                            </v-tab>
                                    ...
                                    <v-tab-item v-if="productType != 'Cooperative' && productType != 'Standard'">
                                        <v-card flat>
                                            <v-card-text class="">
                                                <ProjectTab/>
                                            </v-card-text>
...
export default {
    ...
    components: {
        ...
        ProjectTab: () => import("./project/ProjectTab"),
