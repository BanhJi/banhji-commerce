<template>
    <v-row>
        <v-col sm="12" cols="12" class="pt-0">
            ...
            <v-dialog v-model="dialogm2" max-width="600px">
                <template v-slot:activator="{ on }">
                    <v-btn color="primary" class="btn_create_new float-right " v-on="on" @click="newClick">
                        {{ $t('new_uom') }}
                    </v-btn>
                </template>
                <v-card>
                    ...
                    <v-card-actions class="modal_footer">
                        <v-row>
                            ...
                            <v-col sm="6" cols="6" class="py-0 text-right">
                                <v-btn color="primary" class="px-3  white--text text-capitalize" @click="onSaveClose">
                                    {{ $t('save_close') }}
                                </v-btn>
                            </v-col>
                        </v-row>
        ...
        <v-col sm="12" clos="12" class="pt-0">
            ...
            <kendo-datasource ref="uomServiceDS"
