<template>
  <v-row>
    ...
    <v-col sm="2" cols="12" class="pt-0">
      <v-dialog v-model="dialogM2" max-width="400px" eager>
...
export default {
  ...
  methods: {
    ...
    goEdit(e) {
      e.preventDefault();
      let grid = kendo.jQuery("#gridSubGroup").data("kendoGrid");
          ...
          subGroupHandler
            ...
            .then((response) => {
              if (response.data.statusCode === 201) {
                ...
                //     }
                //     const grid = kendo.jQuery("#gridSubGroup").data("kendoGrid");
                //     grid.refresh()
                //
                // } else {
        ...
        setTimeout(() => {
          ...
          subGroupHandler.get().then((res) => {
            ...
            this.subGroups = res.filter(
              (o) => o.group.category.type.name === "Service"
            );
            // res.forEach(i => {
            //     const group = i.group
