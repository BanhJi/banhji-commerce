                      ...
                      <v-card-text cl ass="modal_text_content">
                        <v-row>
                            <v-col sm="6" cols="12" class="pb-0">
                                ...
                                <v-text-field class="mt-1" v-bind:value="prefix.name"
                                              outlined
                                ...
                                <v-text-field class="mt-1" v-bind:value="prefix.number" type="number"
                                ...
                                <v-text-field class="mt-1" v-bind:value="prefix.format" type="number"
                            ...
                            <v-col sm="6" cols="12" class="pb-0">
                                ...
                                <v-text-field class="mt-1" v-bind:value="prefix.preview"
                                              outlined
                                              readonly
                                              tage="Preview"
                                              placeholder=""
            ...
            <template>
                <v-simple-table class="exchange-table">
                    <template v-slot:default>
                        <thead>
                        <tr>
                            <th class="text-uppercase">ABBR</th>
                        ...
                        <tr v-for="prefix in account_prefixes" v-bind:key="prefix.sk">
                            ...
                            <td class="tb_name_td" width="15%" style="text-align: left">
                                {{prefix.name}}
                            </td>
        ...
        methods: {
            ...
            async onSaveClose() {
                new Promise(resolve => {
                    setTimeout(() => {
                        resolve('resolved');
                        axios.put(apiUrl.prefix_put + this.prefix.sk, {
            ...
            async loadAccountPrefixes() {
                new Promise(resolve => {
                    setTimeout(() => {
                        resolve('resolved');
                        axios.get(apiUrl.wcap_prefix_get)
                            .then(res => {
                                //eslint-disable-next-line no-console
                                // console.log(res.data.data.Items)
                                this.compeletLoading = false
                                this.account_prefixes = res.data.data.Items
                            })
                    }, 300);
                })
            },
