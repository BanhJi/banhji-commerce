      ...
      <v-dialog v-model="dialog" scrollable max-width="1024px">
        <v-card>
          ...
          <v-card-text cl ass="modal_text_content">
            <v-row>
              <v-col sm="3" cols="12" class="">
                ...
                <p class="text_tip">{{ $t("input_title_form") }}</p>
                <v-text-field class=" mb-3" outlined placeholder="" />

                <label class="label">{{ $t("position_of_logo") }}</label>
                <v-row>
                  <v-col sm="4" cols="4" class="text-center">
                    <v-text-field class="" outlined placeholder="" />
                    Center
                  </v-col>
                  <v-col sm="4" cols="4" class="text-center">
                    <v-text-field class="" outlined placeholder="" />
                ...
                <v-row>
                  <v-col sm="4" cols="4" class="text-center">
                    <v-text-field class="" outlined placeholder="1" />
                  </v-col>
                  <v-col sm="8" cols="4" class="text-center">
                    <v-text-field class="" outlined placeholder="Prepared by" />
                  </v-col>

                  <v-col sm="4" cols="4" class="text-center pt-0">
                    <v-text-field class="" outlined placeholder="2" />
                  </v-col>
                  <v-col sm="8" cols="4" class="text-center pt-0">
                    <v-text-field class="" outlined placeholder="Reviewed by" />
                  </v-col>

                  <v-col sm="4" cols="4" class="text-center pt-0">
                    <v-text-field class="" outlined placeholder="3" />
                  </v-col>
                  <v-col sm="8" cols="4" class="text-center pt-0">
                    <v-text-field class="" outlined placeholder="Verified by" />
                  </v-col>

                  <v-col sm="4" cols="4" class="text-center pt-0">
                    <v-text-field class="" outlined placeholder="4" />
                  </v-col>
                  <v-col sm="8" cols="4" class="text-center pt-0">
                    <v-text-field class="" outlined placeholder="Approved by" />
                  </v-col>
                  ...
                  <v-col sm="8" cols="4" class="text-center pt-0">
                    <v-text-field class="" outlined placeholder="Recorded by" />
                  </v-col>
                </v-row>
              </v-col>
                    ...
                    <v-row class="header">
                      ...
                      <v-col sm="10" cols="12" class="pb-0">
                        ...
                        <p class="address">
                          Address:
                          <span
                            >No. 113, Mao Tse Toung Blvd(245),Parkway Square,
                            1st Floor, Phnom Penh.KH</span
                          >
                        </p>
                        <p class="phone_email">
                          Phone:
                      ...
                      <v-col sm="12" cols="12">
                        ...
                        <v-simple-table class="custom_table">
                          <template v-slot:default>
                            <thead>
                              <tr>
                                <th style="width: 30%" class="text-bold">
                                  Type of Transaction
                                </th>
          ...
          <v-card-actions class="modal_footer">
            <v-btn class="btn_save_close float-right" @click="dialog = false"
              >{{$t('save_close')}}</v-btn
            >
          </v-card-actions>
        </v-card>
