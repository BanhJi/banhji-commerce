            ...
            <v-card color="white" class="pl-2 no_border" elevation="0">
                <v-row>
                    <v-col sm="10" cols="12" class="pt-0">
                        <h2 class="mb-1 font_20">{{$t('key_value_items')}}</h2>
                        <p class="mb-0">{{$t('key_value_items_desc')}}</p>
                    </v-col>
                    <v-col sm="2" cols="12" class="pb-0 mt-5 text-right">
                        ...
                        <template>
                            <v-simple-table class="attachment_table">
                                <template v-slot:default>
                                    ...
                                    <tr>
                                        <th>{{$t('name')}} </th>
                                        <th>{{$t('%_in_each_sale')}} </th>
                                        <th>{{$t('no_of_sales')}} </th>
                                        <th>{{$t('average_price')}} </th>
                                        <th>{{$t('margin')}} </th>
                                        <th>{{$t('turnover_days')}} </th>
                                        <th>{{$t('%_of_categories_is_sale')}} </th>
                                        <th>{{$t('%_of_total_sale')}} </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
