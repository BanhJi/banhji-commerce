  ...
  <v-row>
    <v-col sm="12" cols="12" class="">
      <v-card color="white" class="pl-2 no_border" elevation="0">
                ...
                <v-row>
                    <v-col sm="6" cols="12" class="pt-0">
                        <v-card outlined dense class="pa-3 no_border white--text d-flex justify-space-between align-center" color="secondary" height="85px">
                            <h3 class="text-left font_13 flex-1 text-uppercase">{{ $t('customers_over_credit_limit') }}</h3>
                    ...
                    <v-col sm="6" cols="12" class="pt-0">
                        <v-card outlined dense class="pa-3 no_border white--text d-flex justify-space-between align-center" color="third" height="85px">
                            <h3 class="text-left text-uppercase font_13 flex-1 ">{{ $t('customer_with_90%_of_limit') }}</h3>
                            <h3 class="text-right mt-2 font_20  flex-1 ">{{ customer90Percentage }}</h3>
                        </v-card>
                    </v-col>
                </v-row>
        ...
        <!--                        <h2 class="mb-1 font_22">{{ $t('credit_limit_decision') }}</h2>-->
        <!--                        <p class="mb-5">{{ $t('credit_limit_decision_desc') }}</p>-->

        <!--                        <v-row>-->
        <!--                            <v-col sm="6" cols="12" class="pt-0">-->
        <!--                                <v-card outlined dense class="pa-3 no_border white&#45;&#45;text" color="third"-->
        <!--                                        height="85px">-->
        <!--                                    <v-row>-->
        <!--                                        <v-col sm="8" cols="12" class="py-0">-->
        <!--                                            <h3 class="text-left text-uppercase">-->
        <!--                                                {{ $t('customers_over_credit_limit') }}</h3>-->
        <!--                                        </v-col>-->
        <!--                                        <v-col sm="4" cols="12" class="">-->
        <!--                                            <h3 class="text-right mt-2 font_20">100</h3>-->
        <!--                                        </v-col>-->
        <!--                                    </v-row>-->
        <!--                                </v-card>-->
        <!--                            </v-col>-->
        ...
        <!--                                            <h3 class="text-left text-uppercase">-->
        <!--                                                {{ $t('customer_with_90%_of_limit') }}</h3>-->
        <!--                                        </v-col>-->
        ...
        <!--                    <v-col sm="4" cols="12">-->
        <!--                        <v-row>-->
        <!--                            <v-col sm="12" cols="12" class="kendo_dropdown_custom py-0">-->
        <!--                                <app-datepicker :initialDate="asOf"-->
        <!--                                                @emitDate="asOf = $event"/>-->
        <!--                                <dropdownlist-->
        <!--                                    :data-items="customerList"-->
