            ...
            <v-row>
              ...
              <v-col sm="12" cols="12" class="py-0">
                ...
                <v-card
                  ...
                  min-height="90"
                >
                  <p class=" mb-0 font_20 text-bold" style="line-height: 25px;">
                    {{ $t("please_contact_our_team") }}
                  </p>
                </v-card>
              ...
              <v-col sm="12" cols="12" class="py-0">
                ...
                <p
                  class="mb-0 mt-10 font_12 greyText--text"
    ...
    loadPartnerService() {
      BankPartnerServiceHandler.getAll().then((res) => {
        ...
        res.data.forEach((value) => {
          if (value.type.toLowerCase() === BankPartnerType.QR) {
