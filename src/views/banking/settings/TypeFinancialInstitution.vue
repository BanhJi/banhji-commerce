<template>
    <v-row class="">
        <v-col sm="12" cols="12" class="py-0">
            <h2 class="font_20 mb-0">{{$t('type_of_financial_institution')}}</h2>

            <p class="mb-0">
                {{$t('type_of_financial_institution_desc')}}
            </p>
        ...
        <v-col sm="12" cols="12">
            <kendo-datasource ref="financialInstituteDS"
            ...
            <kendo-grid id="gridBankTransactionRule"
                :data-source-ref="'financialInstituteDS'"
                :noRecords="true"
                :column-menu="true"
                :navigatable="true"
                :pageable="true"
...
<script>
    ...
    export default {
        data: () => ({
            transportUrl : apiUrl.financial_institute_types,
            schemaModelFields: {
