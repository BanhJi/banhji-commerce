            ...
            <v-row>
                <v-col sm="12" cols="12">
                    <v-card outlined dense class="pa-4 no_border rounded-sm" color="white">
                        <v-toolbar flat>
                            <v-toolbar-title><h2 class="mb-0">{{ $t('add_purchase') }}</h2></v-toolbar-title>
                            <v-spacer></v-spacer>
                            <v-toolbar-items>
                                <v-icon
                                    @click="onClose"
                                        ...
                                        >
                                            <template v-slot:activator="{ on, attrs }">
                                                <v-text-field
                                                    ...
                                                    v-on="on"
                                                    v-bind="attrs"
                                                    @click:clear="purchase.date = undefined"
...
<script src="./_add_purchase.js" lang="js"></script>
