                        ...
                        <v-col sm="12" cols="12" class="pt-0">
                            <v-row>
                                <v-col sm="6" cols="12" class="py-0">
                                    <h2 class="mb-0 font_20">{{$t('withholding_tax_non_resident')}}</h2>
                        ...
                        <v-col sm="12" cols="12" class="py-0">
                            <v-simple-table>
                                <template v-slot:default>
                                    ...
                                    <tbody>
                                    <tr>
                                        <td>{{$t('wht_non_resident_desc1')}}</td>
                                        <td class="">14%</td>
                                        <td class="">{{ wh1 }}</td>
                                    </tr>
                                    <tr>
                                        <td>{{$t('wht_non_resident_desc2')}}</td>
                                        <td class="">14%</td>
                                        <td class="">{{ wh2 }}</td>
                                    </tr>
                                    <tr>
                                        <td>{{$t('wht_non_resident_desc3')}}</td>
                                        <td class="">14%</td>
                                        <td class="">{{ wh3 }}</td>
                                    </tr>
                                    <tr>
                                        <td>{{$t('wht_non_resident_desc4')}}</td>
                                        <td class="">14%</td>
                                        <td class="">{{ wh4 }}</td>
                                    </tr>
                                    <tr>
                                        <td>{{$t('wht_non_resident_desc5')}}</td>
                                        <td class="">14%</td>
                                        <td class="">{{ wh5 }}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="third white--text text-left text-uppercase text-bold">{{ $t('total') }}</td>
