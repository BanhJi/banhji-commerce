                    ...
                    >
                      <v-row>
                        <v-col sm="12" class="">
                          ...
                          <p class="color_grey font_14 mb-1">
                            {{ $t("ecommerce_desc") }}
                          </p>
                          <v-row>
                            <v-col sm="12" cols="12" class="py-0 pt-0">
                              ...
                              <input
                                ...
                                v-model="
                                  productVariant.isNegativeSaleForSaleChannel
                                "
                              />
                              <label for="isNegativeSaleForSaleChannel">{{
                                $t("selling_past_inter")
                              }}</label>
