        ...
        <v-row class="mt-0">
          <v-col sm="12" cols="12" class="py-0">
            <template>
              ...
              <kendo-datasource ref="dataSource" :data="receivableList"/>
              <kendo-grid
                  id="gridReceivable"
                  class="grid-function"
              ...
              >
                ...
                <kendo-grid-column
                    ...
                    :template="
                    '<span>#=kendo.toString(committedStock, decimalFormat)#</span>'
                  "
                    :headerAttributes="{
                    style: 'background-color: #EDF1F5',
                  }"
                ...
                <kendo-grid-column
                    ...
                    :attributes="{ style: 'text-align: right; ' }"
                    :template="
                    '<span>#=kendo.toString(qoh, decimalFormat)#</span>'
                  "
                    :headerAttributes="{
                    style: 'background-color: #EDF1F5',
                  }"
                ...
                <kendo-grid-column
                    ...
                    :attributes="{ style: 'text-align: right; ' }"
                    :template="
                    '<span>#=kendo.toString(wac, decimalFormat)#</span>'
                  "
                    :headerAttributes="{
                    style: 'background-color: #EDF1F5',
                  }"
                ...
                <kendo-grid-column
                    ...
                    :attributes="{ style: 'text-align: right; ' }"
                    :template="
                    '<span>#=kendo.toString(bValue, decimalFormat)#</span>'
                  "
                    :headerAttributes="{
                    style: 'background-color: #EDF1F5',
                  }"
