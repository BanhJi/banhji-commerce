...
export default {
    ...
    methods: {
        goEdit(e) {
            ...
            this.uomId = dataItem.id || ''
            this.mUOMCategory = dataItem.category || {}
            this.uocId = dataItem.category.id
            this.dialogM2 = true
        },
        rowNumberTmpl(dataItem) {
            let ds = this.$refs.uomDS.kendoWidget(),
            ...
            new Promise(resolve => {
                setTimeout(() => {
                    ...
                    if (this.uomId === '') {
                        ...
                        const category = this.mUOMCategory || {}
                        let data = {
                            "name": this.name,
                            "category": {
                                id: category.id,
        ...
        exportToExcel() {
            const grid = $("#gridUOM").data("kendoGrid")
            grid.saveAsExcel()
        },
    },
