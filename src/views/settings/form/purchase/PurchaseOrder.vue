...
import { PurchaseOrder, print } from "@/form/Purchases.js";
const {
  getFormSetting,
  formSettingCreate,
  deleteFormSetting,
...
let def = {
  title: {
    en: { name: "Purchase Order", status: true },
    kh: { name: "កំ​ម៉​ង់​ទិញ", status: true },
  },
...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      invoice_setting: def,
      form_invoice: PurchaseOrder(this.items, def),
      slider_widht: 5,
      slider_height: 5,
      image_size: {
        width: "100px",
      ...
      if (this.pk != "") {
        deleteFormSetting(params).then((res) => {
          ...
          if (res.data.statusCode === 200) {
            ...
            this.form_invoice = PurchaseOrder(this.items, this.invoice_setting);
          } else {
