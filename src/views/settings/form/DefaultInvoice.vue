...
import { DefaultInvoice, print } from "@/form/invoices.js";
const {
  getFormSetting,
  formSettingCreate,
  deleteFormSetting,
...
let def = {
  ...
  logo: { width: 200, height: 120, position: "left", hide: true, isPrimary: false },
  header: true,
  page: "A4",
  form_number: 1,
  table_header: 1,
...
export default {
  ...
  data() {
    return {
      ...
      invoice_setting: {
        title: "General Invoice",
        page: "A5",
        logo: { width: 200, height: 120, position: "left", hide: true },
        color: { background: "#3B393E", color: "#ffffff" },
        header: true,
        signature: {
  ...
  methods: {
      ...
      if (this.pk != "") {
        deleteFormSetting(params).then(async (res) => {
          if (res.data.statusCode === 200) {
            ...
            this.form_invoice = await DefaultInvoice(
              this.items,
    ...
    getFormSettingS() {
      let params = "?formType=General Invoice";
