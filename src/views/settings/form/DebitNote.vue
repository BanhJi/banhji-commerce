...
import { DebitNote, print } from "@/form/DebitNote.js";
const {
  getFormSetting,
  formSettingCreate,
  deleteFormSetting,
...
let def = {
  title: {
    en: { name: "Debit Note", status: true },
    kh: { name: "កំណត់សំគាល់ឥណពន្ធ", status: true },
  },
...
export default {
  ...
  data() {
    return {
      ...
      sk: "",
      invoice_setting: def,
      form_invoice: DebitNote(this.items, def),
      slider_widht: 5,
      slider_height: 5,
      image_size: {
        width: "100px",
      ...
      if (this.pk != "") {
        deleteFormSetting(params).then((res) => {
          ...
          if (res.data.statusCode === 200) {
            ...
            this.form_invoice = DebitNote(this.items, this.invoice_setting);
          } else {
