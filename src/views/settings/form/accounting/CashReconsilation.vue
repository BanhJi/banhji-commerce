                ...
                <v-row>
                  ...
                  <v-col sm="12" cols="4" class="pl-0">
                    ...
                    <div class="d-flex">
                      ...
                      />
                      <label>{{ $t("exchnaged_amount") }}</label>
                    </div>
                    <div class="d-flex">
                      <v-checkbox
                        @change="UpdateFormChange"
...
import { CashReconciliation, print } from "@/form/Accounting.js";
const {
  getFormSetting,
  formSettingCreate,
  deleteFormSetting,
...
let def = {
  title: {
    en: { name: "Cash Reconciliation", status: true },
    kh: { name: "សាច់ប្រាក់", status: true },
  },
  logo: { width: 140, height: 80, position: "left", hide: false , isPrimary: false},
  header: false,
  page: "A4",
  form_number: 1,
  table_header: 1,
  ...
  headerFontSize: 18,
  margin: 75,
  color: { background: "#3B393E", color: "#ffffff",background2: "#3B393E", color2: "#ffffff"  },
  column: {
    one: true,
    two: true,
    three: true,
...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      invoice_setting: def,
      form_invoice: CashReconciliation(this.items, def),
      slider_widht: 5,
      slider_height: 5,
      image_size: {
        width: "100px",
  ...
  methods: {
      ...
      if (this.pk != "") {
        deleteFormSetting(params).then((res) => {
          ...
          if (res.data.statusCode === 200) {
            ...
            this.form_invoice = CashReconciliation(
              this.items,
    ...
    getFormSettingS() {
      let params = "?formType=CashReconciliation";
    ...
    UpdateFormChange() {
      this.form_invoice = CashReconciliation(this.items, this.invoice_setting);
    },
    logoPosition(pos) {
