        ...
        <v-col sm="12" cols="12" class="pt-0">
          <div class="a4">
            ...
            <div
              ...
              style="
                box-shadow: rgb(0 0 0 / 20%) 0px 6px 12px 0px;
                padding: 72px;
                min-height: 297mm;
              "
            >
          ...
          <v-card-text class="modal_text_content">
            <v-row>
              <v-col sm="3" cols="12" class="hide_msg">
                ...
                />
                <label class="label">{{ $t("form_options") }}</label>
                <v-radio-group
                  class="mt-0 mb-0 custom-radio"
                  @change="UpdateFormChange"
                  v-model="invoice_setting.form_number"
                  row
                >
                ...
                <v-row>
                  ...
                  <v-col sm="2" cols="2" class="text-center pt-0">
                    <v-checkbox
                      @change="UpdateFormChange"
                      class="mt-1"
                      v-model="invoice_setting.signature.posted_by.status"
                    />
                  </v-col>
                  <v-col sm="10" cols="10" class="text-center pt-0">
                    <v-text-field
                      ...
                      v-model="invoice_setting.signature.posted_by.text"
                    />
                    <v-text-field
                      class=""
                      outlined
                      @change="UpdateFormChange"
                      placeholder="khmer language"
                      v-model="invoice_setting.signature.posted_by.text_kh"
                    />
                  </v-col>
                ...
                <v-row class="mx-0">
                  ...
                  <v-col sm="12" cols="4" class="pt-2 pl-0">
                  ...
                  <v-col sm="12" cols="4" class="pl-0">
                    ...
                    <div class="d-flex">
                      ...
                      />
                      <label>{{ $t("vendor_invoice_no") }}</label>
                    </div>
                    <div class="d-flex">
                      <v-checkbox
                        @change="UpdateFormChange"
                    ...
                    <div class="d-flex">
                      ...
                      />
                      <label>{{ $t("amount_to_be_paid") }}</label>
                    </div>
                    <div class="d-flex">
                      <v-checkbox
                        @change="UpdateFormChange"
              ...
              <v-col sm="9" cols="11" class="bg_white">
                <div class="ma-3 mt-6">
                  <div
                    :style="{
                      'padding-left':
                        invoice_setting.margin / 100 + 'in !important',
                      'padding-right':
                        invoice_setting.margin / 100 + 'in !important',
                    }"
                    style="
...
let def = {
  ...
  logo: { width: 140, height: 140, position: "left", hide: false, isPrimary: false },
  header: false,
  form_number: 1,
  table_header: 1,
  margin: 75,
  ...
  signature: {
    ...
    approved_by: { status: true, text: "Approved By", text_kh: "អនុម័តដោយ" },
    posted_by: { status: true, text: "Posted By", text_kh: "ប្រកាសដោយ" },
...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      invoice_setting: def,
      form_invoice: PaymentVoucher(this.items, def),
      slider_widht: 5,
      slider_height: 5,
      image_size: {
        width: "100px",
  ...
  methods: {
      ...
      if (this.pk != "") {
        deleteFormSetting(params).then((res) => {
          ...
          if (res.data.statusCode === 200) {
            ...
            if (this.invoice_setting.form_number === 1) {
              this.form_invoice = PaymentVoucher(
                this.items,
                this.invoice_setting
              );
            } else {
              this.form_invoice = PaymentVoucher2(
                this.items,
                this.invoice_setting
              );
            }
    ...
    getFormSettingS() {
      let params = "?formType=Payment Voucher";
    ...
    UpdateFormChange() {
      if (this.invoice_setting.form_number === 1) {
        this.form_invoice = PaymentVoucher(this.items, this.invoice_setting);
      } else {
        this.form_invoice = PaymentVoucher2(this.items, this.invoice_setting);
      }
    },
    logoPosition(pos) {
