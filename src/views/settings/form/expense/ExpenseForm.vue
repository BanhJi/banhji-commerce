...
import { Expense, print } from "@/form/Purchases.js";
const {
  getFormSetting,
  formSettingCreate,
  deleteFormSetting,
...
let def = {
  title: {
    en: { name: "Expense", status: true },
    kh: { name: "ចំណាយ", status: true },
  },
...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      invoice_setting: def,
      form_invoice: Expense(this.items, def),
      slider_widht: 5,
      slider_height: 5,
      image_size: {
        width: "100px",
      ...
      if (this.pk != "") {
        deleteFormSetting(params).then((res) => {
          ...
          if (res.data.statusCode === 200) {
            ...
            this.form_invoice = Expense(this.items, this.invoice_setting);
          } else {
