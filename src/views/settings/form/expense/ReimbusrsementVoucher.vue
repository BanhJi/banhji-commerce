...
import { ReimbursememtVourcher, print } from "@/form/Expense.js";
const {
  getFormSetting,
  formSettingCreate,
  deleteFormSetting,
...
let def = {
  title: {
    en: { name: "Reimbursement Voucher", status: true },
    kh: { name: "សក្ខីប័ត្រសំណង", status: true },
  },
...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      invoice_setting: def,
      form_invoice: ReimbursememtVourcher(this.items, def),
      slider_widht: 5,
      slider_height: 5,
      image_size: {
        width: "100px",
  ...
  methods: {
      ...
      if (this.pk != "") {
        deleteFormSetting(params).then((res) => {
          ...
          if (res.data.statusCode === 200) {
            ...
            this.form_invoice = ReimbursememtVourcher(
              this.items,
    ...
    saveForm() {
      ...
      let data = {
        type: "form",
        formType: "Reimbursement Voucher",
