...
import { GetReceipt, print } from "@/form/Sale.js";
...
let def = {
  title: {
    ...
    kh: { name: "បង្កាន់ដៃបង់ប្រាក់", status: true },
  },
  ...
  signature: {
    prepared_by: { status: true, text: "Prepare By", text_kh: "អ្នករៀបចំបង្កាន់ដែ" },
    reviewed_by: {
      status: true,
      text: "Reviewed By",
      text_kh: "ត្រួតពិនិត្យដោយ",
    },
    verified_by: { status: true, text: "Banhji", text_kh: "សំរេចដោយ" },
...
export default {
  ...
  data() {
    return {
      ...
      pk: "",
      invoice_setting: def,
      form_invoice: GetReceipt(this.items, "id_23e", def),
      slider_widht: 5,
      slider_height: 5,
      image_size: {
        width: "100px",
      ...
      if (this.pk != "") {
        deleteFormSetting(params).then(async (res) => {
          if (res.data.statusCode === 200) {
            ...
            this.form_invoice = await GetReceipt(
              this.items,
