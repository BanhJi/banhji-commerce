            ...
            <v-card color="white" class="pa-3 no_border" elevation="0">
                <v-row>
                    <v-col sm="12" cols="12" class="py-0">
                        <h2 class="mb-0 font_20">{{ $t('rack') }}</h2>
                                        ...
                                        <v-row>
                                            <v-col sm="12" cols="12" class="pb-0">
                                                ...
                                                <v-text-field class="mt-1"
                                                              ...
                                                              required
                                                              placeholder="" v-model="rack.name"/>
                                                <label class="label">{{ $t('zone') }}</label>
                                                <v-select class=" mt-1"
                                                          id="zon_selector"
                                                          :items="zoneList"
                                                          v-model="rack.zone"
                                                          @change="loadSectionSetting"
                                                          item-text="name"
                                                          tage="Zone"
                                                          item-value="id"
                                                          outlined
                        ...
                        <template>
                            <v-simple-table class="exchange-table">
                                <template v-slot:default>
                                    ...
                                    <tbody>
                                    <tr v-for="rack in racks" v-bind:key="rack.id">
                                        <td>{{ rack.code }}</td>
                                        <td class="text-bold">{{ rack.name }}</td>
                                        <td>{{ rack.zone ? rack.zone.name : '' }}</td>
                                        <td>{{ rack.sec ? rack.sec.name : '' }}</td>
                                        <td>
                                            <v-btn class="btn_edit_setting" @click="onEditClick(rack)">
