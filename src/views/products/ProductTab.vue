                                ...
                                <v-tabs v-model="active_in_tabs">
                                    <v-row>
                                        <v-col sm="10" cols="10" class="py-0 pr-0" style="display: inherit;">
                                            ...
                                            <!-- <v-tab v-if="productType != 'cooperative' && productType != 'Standard' && productType != 'Premium'">
                                               <span>
                                                    {{ $t('warehouse') }}
                                                </span>
                                           </v-tab> -->
                                        ...
                                        <v-col sm="2" cols="2" class="px-0">
                                            ...
                                            >
                                                ...
                                                <v-list>
                                                    ...
                                                    <v-list-item link route to="product_import">
                                                        <v-list-item-title>{{ $t('import_product') }}</v-list-item-title>
                                                    </v-list-item>
                                                </v-list>
                                            </v-menu>
                                        </v-col>
                                   ...
                                   <v-tab-item v-if="productType != 'cooperative' && productType != 'Standard' && productType != 'Premium'">
                                       <v-card flat>
                                           <v-card-text class="">
                                               <WarehouseManagement/>
                                           </v-card-text>
...
export default {
    ...
    components: {
        ...
        CountAdjustment: () => import("./count_adjustment/CountAdjustment"),
