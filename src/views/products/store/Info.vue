<template>
  <v-row>
          ...
          <v-simple-table>
            <template v-slot:default>
              <tbody>
                ...
                <tr>
                  <td class="text-uppercase">{{ $t("segment") }}</td>
                  <td class="text-uppercase">:</td>
                  <td class="text-left text-bold">{{ product.sku || "" }}</td>
                </tr>
                <tr>
                  <td class="text-uppercase">{{ $t("warehouse") }}</td>
                  <td class="text-uppercase">:</td>
                  <td class="text-left text-bold">{{ category }}</td>
                </tr>
                <tr>
                  <td class="text-uppercase">{{ $t("user") }}</td>
                  <td class="text-uppercase">:</td>
    ...
    <v-col sm="12" cols="12" class="pt-0 pl-0 pr-2">
      <div class="grayBg">
...
export default {
  ...
  methods: {
    ...
    toolbarTemplate: function () {
      const templateHtml =
        "<span>" +
        '<a class="k-pager-refresh k-link k-button reload" title="Refresh">Load Data</span></a>' +
        "</span>" +
