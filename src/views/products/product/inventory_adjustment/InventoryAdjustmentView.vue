              ...
              >
                <v-form ref="form" v-model="valid" lazy-validation>
                  ...
                  <v-card
                    outlined
                    dense
                    class="no_border function_footer mt-0 py-2"
                  >
                    <p class="float-left color_grey py-3 mb-0">
                      {{ $t("standard_inventory_adjustment") }}
                    </p>
                    <v-btn @click="printHandle" color="primary" class="white&#45;&#45;text float-right  mx-1 text-capitalize">
                      {{ $t('print') }}
                    </v-btn>
                    ...
                    <!-- <v-btn
                      color="primary"
                      class="white--text float-right mx-1 text-capitalize"
                      @click="onEdit('edit')"
                    >
                      {{ $t("edit") }}
                    </v-btn> -->
          ...
          billingHandler
            ...
            .then((res) => {
              if (res.data.statusCode === 200) {
                ...
                this.dateFormat =
                  this.inventoryAdjustment.dateFormat || "dd-MM-yyyy";
