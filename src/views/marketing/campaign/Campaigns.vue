                                            ...
                                            <v-row>
                                                <v-col sm="2" cols="12" >
                                                 ...
                                                 <v-col sm="10" cols="12" class="pa-6" >
                                                      <div v-show="steps==1">
                                                            <StepOne @stepOne="nextStpes($event, 1)" ref="" />
                                                        </div>
                                                        <!-- Steps 2 Adjustemnt -->
                                                        <div  v-show="steps==2">
                                                            <StepTwo  @stepTwo="nextStpes($event,2)"  ref=""/>
                                                        </div>
                                                        <!-- Steps four -->
                                                        <div  v-show="steps==3">
                                                            <StepTree   @finish="finish($event)"   ref="" />
                                                        </div>
                                                            </v-col>
                                                        </v-row>
...
<script>
    ...
    import StepOne from './step_campaign/StepOne'
    import StepTwo from './step_campaign/StepTwo'
    import StepTree from './step_campaign/StepTree'
    export default {
        name: "AddProduct",
        props: ['dataUpdate'],
        components:{
