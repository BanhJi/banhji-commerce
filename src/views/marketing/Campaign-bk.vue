                                ...
                                <v-col class="bigSide py-0 pr-2" sm="12" cols="12" style="transition: .3s ease-in;"
                                    ...
                                    <v-card outlined dense class="no_border" color="white">
                                        <v-row>
                                            ...
                                            <v-col v-if="c.type == `coupon`" sm="3" cols="12" class="">
                                                <v-text-field
                                                    class="mt-1"
                                            ...
                                            <v-col sm="3" cols="12" class="pb-0">
                                                ...
                                                <label class="label mb-0">{{ $t('partner') }}</label>
                                                <v-switch
                                                    v-model="c.isPartner"
                                                    color="primary"
                                                    :label="c.isPartner ? $t('yes') : $t('no')"
                                                />
                                                <v-col v-if="c.isPartner" style="clear: both;width: 100%;overflow: hidden;">
                                                    ...
                                                    />
                                                    <v-col>
                                                        <label class="label">{{ $t('share_amount') }}</label>
                                                        <v-text-field
                                                            class="mt-1"
                                                ...
                                                <v-select
                                                    ...
                                                    outlined=""
                                                />
                                                <v-col v-if="c.ruleBase == `customer`">
                                                    <label class="label">{{ $t('customer_base') }}</label>
                                                    <v-select
                                                        class="mt-1"
                                                        ...
                                                        outlined=""
                                                    />
                                                    <v-col v-if="c.ruleCustomerBaseType == `customerType`">
                                                        <v-combobox
                                                    ...
                                                    <v-col v-else-if="c.ruleCustomerBaseType == `specific`">
                                                        <template>
                                                            <kendo-datasource
                                                                ref="ruleCustomers"
                                                                :data="ruleCustomers"/>
                                                ...
                                                <v-col v-else>
                                                    ...
                                                    <v-select
                                                        ...
                                                        outlined=""
                                                    />
                                                    <v-col v-if="c.ruleProductBaseOn == `category`">
                                                        <template>
                                                            <kendo-datasource
                                                                ref="ruleCate"
                                                                :data="ruleCate"/>
                                                    ...
                                                    <v-col v-else-if="c.ruleProductBaseOn == `group`">
                                                        <template>
                                                            <kendo-datasource
                                                                ref="ruleGroup"
                                                                :data="ruleGroup"/>
                                                    ...
                                                    <v-col v-else-if="c.ruleProductBaseOn == `specific`">
                                                        <template>
                                                            <kendo-datasource
                                                                ref="ruleProduct"
                                                                :data="ruleProduct"/>
                                            ...
                                            <v-col sm="3" cols="12" class="pb-0">
                                                ...
                                                <v-col v-if="c.rewardBase == `amountBase`">
                                                    ...
                                                    <v-select
                                                        ...
                                                        outlined=""
                                                    />
                                                    <v-col v-if="c.rewardType == `fixed`">
                                                        <label class="label" >{{ $t('reward_amount') }}</label>
                                                        <v-text-field
                                                            class="mt-1"
                                                            style="width: 80%;float: left;"
                                                ...
                                                <v-col v-else>
                                                    ...
                                                    <v-select
                                                        ...
                                                        outlined=""
                                                    />
                                                    <v-col v-if="c.productBaseOn == `category`">
                                                        <template>
                                                            <kendo-datasource
                                                    ...
                                                    <v-col v-else-if="c.productBaseOn == `group`">
                                                        <template>
                                                            <kendo-datasource
                                                    ...
                                                    <v-col v-else-if="c.productBaseOn == `specific`">
                                                        <template>
                                                            <kendo-datasource
                                                                ref="selectProList"
                                                                :data="producSelected"/>
