    ...
    <v-row class="">
        <v-col sm="12" cols="12" class="grayBg">
            <v-card color="white" class="pa-3 no_border" elevation="0">
                <v-row>
                    <v-col sm="10" cols="12">
                        <h2 class="mb-0 font_20">{{ $t("custom_field") }}</h2>
                        <p class="mb-0">{{ $t("custom_setting_desc") }}</p>
                    </v-col>
                    <v-col sm="2" cols="12">
                        <v-dialog v-model="dialogM2" max-width="400px">
                            ...
                            <v-card>
                                <div class="modal_header">
                                    <v-card-title>{{ $t("custom_field") }}</v-card-title>
                                    ...
                                    <v-form ref="form" v-model="valid" lazy-validation>
                                        <v-row>
                                            ...
                                            <v-col sm="12" cols="12" class="py-0">
                                                <label class="label">{{ $t("attribute") }}</label>
                                                <v-select
                                                    class="mt-2"
                    ...
                    <v-col sm="12" cols="12">
                        <template>
                            ...
                            <kendo-grid
                                ...
                                :excel-file-name="'SaleChannelList.xlsx'"
