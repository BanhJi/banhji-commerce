                    ...
                    <v-col sm="12" cols="12" class="py-0">
                        <kendo-datasource 
                            ...
                            <kendo-grid 
                                ...
                                :excel-file-name="$t('transaction')+'.xlsx'"
                                ...
                                <kendo-grid-column 
                                    :field="'isType'" 
                                    :hidden="true" 
                                    :template="'<span>#=isType === 1 ? `Serial` : `Batch` #</span>'" 
                                    :title="$t('nature')" 
                                    :width="120" 
                                    :headerAttributes="{
                                        style: 'background-color: #EDF1F5'
                                ...
                                <kendo-grid-column 
                                    :field="'serialBatch'" 
                                    :template="'<span>#=serialBatch#</span>'" 
                                    :title="$t('serial_batch')" 
                                    :width="120" 
                                    :headerAttributes="{
                                        style: 'background-color: #EDF1F5'
                                    }"/>
                                <kendo-grid-column :field="'serialNumber2'" 
                                    :hidden="true" 
                                    :template="'<span>#=serialNumber2#</span>'" 
                                    :title="$t('serial2')" 
                                    :width="120" :headerAttributes="{
                                        style: 'background-color: #EDF1F5'
                                    }"/>
                                <kendo-grid-column 
