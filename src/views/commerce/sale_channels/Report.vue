  ...
  <v-row>
    <v-col sm="12" cols="12" class="grayBg px-6">
      <v-card color="white" class="pa-3 no_border" elevation="0">
        <h2 class="mb-1 font_20">{{ $t("channel_report") }}</h2>
        ...
        <div style="overflow: auto" class="sale-channel-report"></div>
      </v-card>
    </v-col>
  </v-row>
</template>
    ...
    async loadPage(that) {
      ...
      $(".sch-report-next-page").click(function () {
        ...
        if (isPrevious == "previous") {
          ...
          $(".sch-report-page-link").removeClass("text-bold-link");
          $(`.sch-report-page-link:eq(${currectpage - 1})`).addClass(
            "text-bold-link"
          );
