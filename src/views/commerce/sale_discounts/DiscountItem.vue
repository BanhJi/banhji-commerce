      ...
      <v-card color="white" class="pa-3 no_border" elevation="0">
        <v-row>
          <v-col sm="7" class="py-0">
            <h2 class="mb-0 font_20">{{ $t("customer_discount_item") }}</h2>
          </v-col>
        ...
        <v-dialog eager v-model="dialogM3" max-width="600px">
          <v-card>
          ...
          <v-col sm="12" cols="12">
            ...
            <template>
              ...
              <kendo-grid
                ...
                :excel-file-name="'DiscountItemList.xlsx'"
...
export default {
  ...
  methods: {
    ...
    goEdit(e) {
      ...
      this.mAccount = {
        account_type: dataItem.account.account_type
          ? dataItem.account.account_type
          : {},
